...
//unlink($dir.'/'.$pimage);
  ...
  move_uploaded_file($_FILES["productimage1"]["tmp_name"],"image/$pid/".$_FILES["productimage1"]["name"]);
...
<img src="image/<?php echo htmlentities($pid);?>/<?php echo htmlentities($row['productImage1']);?>" class="col-sm-20 " width="200" height="100"> 
</div>
</div>
...
<div class="col-sm-2">
<input type="file" name="productimage1" id="productimage1" value=""  class="col-sm-20 " required>
</div>
</div>
