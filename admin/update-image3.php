...
//unlink($dir.'/'.$pimage);
  ...
  move_uploaded_file($_FILES["productimage3"]["tmp_name"],"image/$pid/".$_FILES["productimage3"]["name"]);
...
<img src="image/<?php echo htmlentities($pid);?>/<?php echo htmlentities($row['productImage3']);?>" class="col-sm-20 " width="200" height="100"> 
</div>
</div>
...
<div class="col-sm-2">
<input type="file" name="productimage3" id="productimage3" value=""  class="col-sm-20 " required>
</div>
</div>
